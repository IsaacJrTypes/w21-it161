...
<html lang="en">
 <head>
  <title>Isaac Jimenez: Contact Form</title>
 ...
 <body>
     <header>
     <h1>Isaac Jimenez: Contact Form</h1>
     <nav class="topnav" id="myTopnav">
       ...
       <a href="contact.php" class="active">Contact Isaac</a>
   ...
   <div class="wrapper">
       ...
       <h2 class="subheader">Contact Isaac</h2>
       <?php
        /*
